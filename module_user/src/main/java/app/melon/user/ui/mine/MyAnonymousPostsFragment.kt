...
class MyAnonymousPostsFragment : BasePagingListFragment() {
    ...
    override val controller by lazy {
        controllerFactory.create(
            ...
            idProvider = { _, position -> "my_anonymous_feeds_$position" },
    ...
    private fun refresh() {
        ...
        fetchJob = lifecycleScope.launch {
            viewModel.myAnonymousFeedsPagingData.collectLatest {
