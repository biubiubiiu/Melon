...
public class CalendarReminderUtils {
     ...
     * @param startTime 开始时间 UTC Time
     * @param endTime 结束时间 UTC Time
     * @param previousDate 提早几天开始提醒
     */
    public static void addCalendarEvent(Context context, String title, String description, long startTime, long endTime, int previousDate) {
        if (context == null) {
            return;
        }
